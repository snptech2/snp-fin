    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-gradient-to-r from-green-500 to-green-600 text-white p-6 rounded-lg">
          ...
          <p className="text-green-100">{statistiche.totalCount} transazioni</p>
        </div>
        <div className="bg-gradient-to-r from-blue-500 to-blue-600 text-white p-6 rounded-lg">
          ...
          <p className="text-blue-100">{statistiche.thisMonth.count} transazioni</p>
        </div>
        <div className="bg-gradient-to-r from-purple-500 to-purple-600 text-white p-6 rounded-lg">
          ...
          <p className="text-purple-100">{statistiche.other.count} transazioni</p>
        </div>
      </div>
            ...
            {filteredTransactions.length === 0 ? (
              <p className="text-gray-500 text-center py-8">
                {searchTerm || selectedCategory || selectedAccount || dateFrom || dateTo 
                  ...
                  : 'Nessuna transazione da mostrare. Aggiungi la tua prima entrata!'
                }
              </p>
            ) : (
              <>
