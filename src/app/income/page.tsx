      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="card-adaptive rounded-lg p-6">
            <h3 className="text-lg font-semibold text-adaptive-900 mb-2">💰 Totale Entrate</h3>
          ...
          <div className="card-adaptive rounded-lg p-6">
            ...
            <p className="text-3xl font-bold text-blue-600">{formatCurrency(currentMonthIncome)}</p>
